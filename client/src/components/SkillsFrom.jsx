  ...
  return (
    <div className='space-y-4'>
      ...
      {data.length > 0 ? (
        ...
        <div>
            <p className='bg-blue-50 p-3 rounded-lg'><strong>Tip: </strong>Add 8-12 relevant skills. Include both technical skills (programming langauges, tools) and soft skills (leadership, communication).</p>
        </div>
    </div>
  )
}
