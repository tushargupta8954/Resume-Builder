...
const Testimonials = () => {
  ...
  return (
    <>
    <div id='testimonials' className='flex flex-col items-center my-12 scroll-mt-12'>
        
         <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-indigo-200 rounded-full px-4 py-1.5">
